...
public class TokenService extends TokenSpecService {
    ...
    protected int getDefaultRefreshTokenLifetimeSeconds() {
        return props.getSecurityDefaultRefreshTokenLifetimeSeconds();
    }

    @Override
    protected int getDefaultTokenLifetimeSeconds() {
        return props.getSecurityDefaultTokenLifetimeSeconds();
    }
}
