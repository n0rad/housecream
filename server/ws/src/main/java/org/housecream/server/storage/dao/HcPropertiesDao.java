...
public class HcPropertiesDao {
    ...
    @Autowired
    public HcPropertiesDao(Session session) {
    ...
    public void loadConfig(HcProperties props) {
        ...
        props.importMap(properties);
    }

    public void saveConfig(HcProperties props) {
        session.execute(update.bind(toMap(props)));
    }

    private Map<String, String> toMap(HcProperties props) {
        Map<String, String> propsMap = new HashMap<>();
        Field[] fields = HcProperties.class.getDeclaredFields();
    ...
    public void saveProperty(String propertyName, String propertyValue) {
        session.execute(updateField.bind(propertyName, propertyValue));
    }
}
