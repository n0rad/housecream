'use strict';
housecream.controller('InpointFormController', function InpointFormController($scope, $location, $routeParams,
		InPoints, Zones) {
	var self = this;
	...
	InPoints.validator(function(validator) {
		$scope.inPoint = $scope.inPoint || {};
		$scope.inPoint.$validator = validator;
	});
	...
	$scope.isSaveDisabled = function() {
		return $scope.inpointForm.$invalid || angular.equals(self.original, $scope.inpoint);
	};
});
...
// housecream.controller('InpointFormNewController', function
// InpointFormNewController($scope, $location, InPoint, InPoints) {
//
// InPoints.getTypes(function(types) {
// $scope.inPointTypes = types;
// });
...
// restFormHandler.handleSubmit(this, rootUrl, "/hcs/ws/inpoint", validatorInfo,
// formData, function() {
...
// },
//
// 'input[type=text], input[type=hidden], checkbox, select,
// textarea|keyup,blur,change' : function() {
...
// var self = this;
// $.getJSON('/hcs/ws/inpoints/types.json', {}, function(inPointTypes) { //TODO
// use when.js
